...
function Verser(props) {
    ...
    const handleSubmit = (e) => {
     ...
     //http://localhost:8050/AGENT/Verser?codeCompte=4584000001&montant=500.0
           else {         
               axios.post(`http://localhost:8050/AGENT/Verser?codeCompte=${numCompte}&montant=${montant}`,
               ...
               agent.token)
                .then(res => {
                    ...
                    console.log(res)
                    setError(false)
                    document.getElementById('requete-result').innerHTML =" Versement effectue avec succes !"
